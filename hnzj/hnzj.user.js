    ...
    function enterCourse() {
        ...
        if (jindu) {
            ...
            if (!document.querySelector("#hnzjfz")){
                document.querySelector("#defaultBtn > span.title").insertAdjacentHTML('afterEnd',"<a href = 'https://greasyfork.org/zh-CN/scripts/389705-%E6%B2%B3%E5%8D%97%E4%B8%93%E6%8A%80%E5%9C%A8%E7%BA%BF%E8%BE%85%E5%8A%A9' target = '_blank'><span id='hnzjfz' style= 'font-weight: 700;float: left;color: #ff0000;line-height: 30px;'>【河南专技在线辅助3.0】<br>&nbsp正在运行中...</span></a><div style= 'font-weight: 700;float: left;color: #ff0000;line-height: 30px;'><input type='checkbox' id='mute' checked onclick='document.querySelector(\".pv-video\").volume = this.checked ? 0 : 0.65;'/> <label for='mute'>静音</label></div>");
            }
