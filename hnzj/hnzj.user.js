    ...
    function enterCourse() {
        ...
        if (jindu) {
            if (!document.querySelector("#hnzjfz")){
                document.querySelector("#defaultBtn > span.title").insertAdjacentHTML('afterEnd',"<ul style='float: left;'><li style= 'font-weight: 700;line-height: 30px;border: 1px dashed red;'><a href = 'https://greasyfork.org/zh-CN/scripts/389705-%E6%B2%B3%E5%8D%97%E4%B8%93%E6%8A%80%E5%9C%A8%E7%BA%BF%E8%BE%85%E5%8A%A9' target = '_blank'><span id='hnzjfz' style='color: red;'>【河南专技在线辅助3.0】</span></a></li><li><div style= 'font-weight: 700;color: white;line-height: 20px;'><ul><li><input type='checkbox' id='switch' checked onclick='this.checked ? setInterval(enterCourse, 3000) : clearInterval(myTimer);'><label for='switch'><span>总开关</span></label><input type='checkbox' id='mute' checked onclick='document.querySelector(\".pv-video\").volume = this.checked ? 0 : 0.65;'/> <label for='mute'><span>静音</span></label></li></ul></div>");
            }
