    ...
    function enterCourse() {
        ...
        if (jindu) {
            if (!document.querySelector("#hnzjfz")){
                document.querySelector("#defaultBtn > span.title").insertAdjacentHTML('afterEnd',"<span id='hnzjfz' style= 'font-weight: 700;float: left;color: #ff0000;line-height: 30px;'>【河南专技在线辅助3.0】<br>&nbsp正在运行中...</span>");
            }
